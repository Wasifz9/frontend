<script lang="ts">
    ...
    const popularStrategyList = [
        ...
        { key: "volatilityBreakout", label: "Volatility Breakout (Std Dev)" },
        { key: "pivotBounce", label: "Pivot Point Support Bounce" },
        { key: "fibonacciRetracement", label: "Fibonacci 61.8% Retracement" },
        { key: "psychologicalLevels", label: "Psychological Level Break" },
        { key: "lowVolatilityBreakout", label: "Low Volatility Breakout" },
    ];
