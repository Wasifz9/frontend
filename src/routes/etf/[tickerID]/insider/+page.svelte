            ...
            {#if senateTradingList?.length !== 0}
              ...
              >
                ...
                >
                  <!--Start Buy/Sell-->
                  <div
                    class="flex flex-row items-center flex-wrap w-full px-3 sm:px-4 border border-gray-300 shadow-xs dark:border-gray-600 bg-gray-200 dark:bg-primary rounded h-20"
                  >
