...
<section class="w-full overflow-hidden m-auto min-h-screen">
  ...
  <div
    class="shadow-xs mt-4 mb-4 flex flex-col divide-y divide-gray-300 dark:divide-gray-600 rounded border border-gray-300 dark:border-gray-600 sm:grid sm:grid-cols-3 sm:divide-x sm:divide-y-0"
  >
