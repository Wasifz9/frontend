    ...
    <div class="sm:p-0 flex justify-center w-full m-auto overflow-hidden">
      ...
      >
        <main class="w-full lg:w-3/4 lg:mr-auto">
          ...
          <div
            class="rounded shadow-xs border border-gray-300 dark:border-gray-600 p-4 xs:p-4 xs:text-lg"
          >
              ...
              <div class="mt-3">
                ...
                {:else if nottifPermGranted === true}
                  ...
                  {:else}
                    ...
                    {:else}
                      <button
                        class="cursor-not-allowed shadow-xs border border-gray-300 dark:border-gray-600 w-fit px-5 py-1.5 bg-white/60 text-black text-sm font-semibold rounded sm:hover:bg-white/80 transition ease-out duration-100"
                        ><div class="flex flex-row m-auto items-center">
          ...
          <div
            class="mt-6 rounded shadow-xs border border-gray-300 dark:border-gray-600 p-4 xs:p-4 xs:text-lg"
          >
...
<dialog id="installModal" class="modal overflow-hidden p-3 sm:p-0">
  ...
  <div
    class="modal-box rounded w-full bg-white dark:bg-secondary shadow-xs border border-gray-300 dark:border-gray-600"
  >
